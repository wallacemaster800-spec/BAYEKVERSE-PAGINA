...
export default function SeriesDetail() {
  ...
  // Scroll top al cambiar de serie
  useEffect(() => {
    window.scrollTo(0, 0);
  }, [slug]);

  // EFECTO: Cuando se selecciona un episodio, subir suavemente al reproductor
  useEffect(() => {
    ...
    <>
      ...
      <Layout>
        <div className="container mx-auto px-4 py-8">
          ...
          {/* SECCIÓN DEL REPRODUCTOR (Ahora es condicional y animada) */}
          {/* Solo se renderiza si hay un episodio seleccionado */}
          <AnimatePresence>
            {selectedEpisode && (
              <motion.div
                ref={playerRef} // Aquí apuntamos el scroll
              ...
              >
                <div>
                  <VideoPlayer videoId={selectedEpisode.youtube_id} title={selectedEpisode.titulo} />
